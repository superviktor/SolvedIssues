...
namespace Validation.Api
{
    public class StudentRepository
    {
        ...
        {
            var alice = new Student("alice@gmail.com", "Alice Alison", new Address("5 Avenue","New York","123"));
            SetId(alice, 1);
        ...
        {
            var bob = new Student("bob@gmail.com", "Bob Bobson", new Address("B.Hmyri","Kiev","03056"));
            SetId(bob, 2);
